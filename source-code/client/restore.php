  ...
  <section class="row">
    <section class="col-md-6 bg-white">
      <section class="p-4 py-3 mt-5 mx-auto w-100">
        ...
        <h4 class="mb-5">Restore Your Account</h4>

        <form method="POST">
          <section class="mb-4 intake">
            <label for="email-intake" class="form-tag text-uppercase"
              >Email</label
            >
            <input
              class="restore-email-input-affirm"
              id="email-intake"
          ...
          >
            <button type="submit" class="restore-affirm">Revive</button>
          </section>
        </form>

        <section
          class="scheme-report d-none d-inline-flex mt-3 bg-danger px-3 py-1 transition-text mb-4 w-100"
        >
    ...
    <section class="col-md-6 d-xl-block d-none d-md-block bg-white">
